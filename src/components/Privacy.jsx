...
<ul>
    <li>
        <p><strong>Service</strong></p>
                <p>Service is the Wotnot Media website operated by http://localhost:3000/</p>
            </li>
    <li>
...
<p>http://localhost:3000/ uses the collected data for various purposes:</p>    
<ul>
...
<p>http://localhost:3000/ will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
...
<ul>
    ...
    <li>To protect and defend the rights or property of http://localhost:3000/</li>
...
<ul>
        <li>By email: wotnotmedia@gmail.com</li>
          
        <li>By phone number: 1300 393 851</li>
        </ul>
        </div>
    )
}
